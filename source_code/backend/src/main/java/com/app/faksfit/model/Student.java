...
public class Student extends User {
    ...
    public Student(String JMBAG, Integer totalPoints, Boolean passStatus, String semester, LocalDateTime academicYear, List<StudentTerminAssoc> terminList, List<Notification> notificationList, Teacher studentTeacher) {
        this.JMBAG = JMBAG;
        this.totalPoints = totalPoints;
        this.passStatus = passStatus;
        this.semester = semester;
    ...
    public LocalDateTime getAcademicYear() {
        return academicYear;
    }

    public void setAcademicYear(LocalDateTime academicYear) {
        this.academicYear = academicYear;
    }
